      ...
      child: Column(
        children: [
          if (_isLoading)
            ...
            SizedBox(height: 8),
            Text(
              '\$${_usdBalance.toStringAsFixed(2)} (${_balance > 0 ? '+' : ''}0.00%)',
              style: TextStyle(
    ...
    return Column(
      children: [
        Container(
          ...
          height: 64,
          decoration: BoxDecoration(
            color: isHighlighted ? Color(0xFF32D74B) : Color(0xFF2C2C2E),
  ...
  Widget _buildNavItem(IconData icon, String label, bool isActive) {
    return Column(
      ...
      children: [
        Icon(
          icon,
          color: isActive ? Color(0xFF32D74B) : Colors.grey[400],
          size: 24,
        ),
        SizedBox(height: 4),
        Text(
